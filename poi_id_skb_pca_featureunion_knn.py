...
pipe = Pipeline([("scaler", MinMaxScaler()), ("features", combined_features), ("logreg", LogisticRegression(random_state=42))])

print "Pipe steps: \n{}".format(pipe.steps)

# parameter grid for selectkbest and classifier:
param_grid = {'features__pca__n_components': range(2, 10), \
              'features__univ_select__k': [1, 5], \
